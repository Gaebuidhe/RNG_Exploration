...
def setup():
    ...
    map_height = int(1.1 * imgh / (.86 * hexagon_size))
    map_width =  int(1.1 * imgw / (hexagon_size * 3))
    ...
    print(type(hex_map[0]))
    filepath = ('D:/Lin-Jie Works/Programming_Projects/RNG_Exploration/map_pyde/Examples/csv/%s.csv' % noise_seed)
